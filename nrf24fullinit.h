...
#define RADIO_IRQ GPIO_PIN_2 //З

#define IRQ_PinState HAL_GPIO_ReadPin(RADIO_IRQ_PORT, RADIO_IRQ)
...
#define radio_assert_ce HAL_GPIO_WritePin(CE_PORT, RADIO_CE, SET)
#define radio_deassert_ce HAL_GPIO_WritePin(CE_PORT, RADIO_CE, RESET)
